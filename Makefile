...
SOURCES = \
	__init__.py \
	Classificator.py Classificator_dockwidget.py

PLUGINNAME = Classificator

PY_FILES = \
	__init__.py \
	Classificator.py Classificator_dockwidget.py

UI_FILES = Classificator_dockwidget_base.ui
...
QGISDIR=C:\Users\anast\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
